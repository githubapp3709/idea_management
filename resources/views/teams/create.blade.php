...
<div x-data="teamBuilder()" class="max-w-6xl mx-auto bg-white p-4 sm:p-6 lg:p-10 rounded-2xl shadow-lg space-y-6">
    ...
    <form method="POST" action="{{ route('teams.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4 bg-gray-50">
                ...
                <div class="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-green-200 to-blue-200 rounded-lg flex items-center justify-center">
                    📷
                </div>

                <div class="text-center sm:text-left">
                    <p class="font-semibold">Upload Team Image</p>
