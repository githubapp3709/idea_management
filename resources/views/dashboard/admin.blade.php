...
<h2 class="text-lg font-semibold mb-4">Filter</h2>
    ...
    {{-- ================= DATE FILTER ================= --}}
    <form method="GET" action="{{ route('dashboard') }}" class="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div class="flex gap-3">
            <button type="submit"
                class="app-btn-primary app-input text-center">
                Apply
            </button>

            <a href="{{ route('dashboard') }}"
                class="app-btn-secondary app-input text-center">
                Reset
            </a>
        </div>
    </form>
    ...
    <div>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div class="bg-indigo-500 text-white p-5 rounded-xl shadow flex items-center justify-between">
                <div>
                    <p>Total</p>
        ...
        <div class="bg-red-500 text-white p-5 rounded-xl shadow flex items-center justify-between">
            <div>
                <p>Rejected</p>
        ...
        <div class="bg-yellow-500 text-white p-5 rounded-xl shadow flex items-center justify-between">
            <div>
                <p>Approval Rate</p>
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="app-card p-4 sm:p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
                ...
                <a href="{{ route('ideas.index') }}" class="text-sm text-indigo-600">
                    View All
                </a>
            </div>
                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border truncate max-w-[150px]">
                                {{ $idea->title }}
                            </td>
